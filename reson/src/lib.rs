...
impl Source {
  pub fn new(f_master_a: f64) -> Self {
    ...
    let c = f_master_a * 2f64.powf(-33./12.);
    let fs = [
     c, c*17.0/16.0, c*9.0/8.0, c*6.0/5.0,
     c*5.0/4.0, c*4.0/3.0, c*45.0/32.0, c*3.0/2.0,
     c*25.0/16.0, c*27.0/16.0, c*9.0/5.0, c*15.0/8.0,
     2.0*c, 2.0*c*17.0/16.0, 2.0*c*9.0/8.0, 2.0*c*6.0/5.0,
     2.0*c*5.0/4.0, 2.0*c*4.0/3.0, 2.0*c*45.0/32.0, 2.0*c*3.0/2.0,
     2.0*c*25.0/16.0, 2.0*c*27.0/16.0, 2.0*c*9.0/5.0, 2.0*c*15.0/8.0,
     4.0*c, 4.0*c*17.0/16.0, 4.0*c*9.0/8.0, 4.0*c*6.0/5.0,
     4.0*c*5.0/4.0, 4.0*c*4.0/3.0, 4.0*c*45.0/32.0, 4.0*c*3.0/2.0,
     4.0*c*25.0/16.0, 4.0*c*27.0/16.0, 4.0*c*9.0/5.0, 4.0*c*15.0/8.0,
     8.0*c, 8.0*c*17.0/16.0, 8.0*c*9.0/8.0, 8.0*c*6.0/5.0,
    ];
    //for i in 0..=39 {
    for f in fs {
      slf.r.push(
